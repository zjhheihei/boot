...
/* Bit definition for Ethernet DMA Transmit Pull Demand Register */
#define ETH_DMATPDR_TPD      ((uint32_t)0xFFFFFFFF)  /* Transmit Pull demand */

/* Bit definition for Ethernet DMA Receive Pull Demand Register */
#define ETH_DMARPDR_RPD      ((uint32_t)0xFFFFFFFF)  /* Receive Pull demand  */
