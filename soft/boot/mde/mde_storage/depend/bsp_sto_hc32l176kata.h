...
void bsp_transfer_user_upgrade_to_app(sdt_int32u in_codesize)
{
    ...
    do
    {
        ...
        M0P_FLASH->BYPASS = 0xA5A5;    
        M0P_FLASH->SLOCK0 = 0xfffffffc;   //only lock boot's sector
    }while(M0P_FLASH->SLOCK0 != 0xfffffffc);

    do
    {
        M0P_FLASH->BYPASS = 0x5A5A;      //unlock
        M0P_FLASH->BYPASS = 0xA5A5;    
        M0P_FLASH->SLOCK1 = 0xffffffff;   //only lock boot's sector
    ...
    *(sdt_int32u*)test_addr = test_reg; 
    ...
    do
    {
        M0P_FLASH->BYPASS = 0x5A5A;      //unlock
        M0P_FLASH->BYPASS = 0xA5A5;    
        M0P_FLASH->SLOCK0 = 0x00000000;   // lock boot and app sector
    }while(M0P_FLASH->SLOCK0 != 0x00000000);
}
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++